...
export default function Hero() {
  return (
  <section className="relative isolate overflow-hidden bg-linear-to-b from-white to-zinc-50 dark:from-black dark:to-zinc-900">
  ...
  <div className="mt-16 lg:mt-0 lg:shrink-0 lg:pl-8">
